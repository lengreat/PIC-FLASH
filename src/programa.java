...
public class programa extends JFrame {
    ...
    private void opcionesModuloIngles() {
        ...
        switch (modulo) {
            ...
            case 1:
                ruta = "SpanishEnglishBATCH-1.xlsx";// CAMBIAR RUTA, INCREMENTO, Y MAX ******************************
                INCREMENTO = 0;// tamanio de filas quitadas
                pathImagenes = "imagenesBatch-1";
                MAX = 30;// SE CAMBIA RESPECTO A LA CANTIDAD DE IMAGENES sin importar el tamanio del
                         // excel
                titular = "Objetos";
                break;
            case 2:
                ruta = "SpanishEnglishBATCH-2.xlsx";// CAMBIAR RUTA, INCREMENTO, Y MAX ******************************
                INCREMENTO = 0;// tamanio de filas quitadas
                pathImagenes = "imagenesBatch-2";
                MAX = 30;// SE CAMBIA RESPECTO A LA CANTIDAD DE IMAGENES sin importar el tamanio del
                         // excel
                titular = "Objetos";
                break;
            case 3:
                ruta = "SpanishEnglishBATCH-3.xlsx";// CAMBIAR RUTA, INCREMENTO, Y MAX ******************************
                INCREMENTO = 0;// tamanio de filas quitadas
                pathImagenes = "imagenesBatch-3";
                MAX = 30;// SE CAMBIA RESPECTO A LA CANTIDAD DE IMAGENES sin importar el tamanio del
                         // excel
                titular = "Objetos";
                break;
